    ...
    <section className="relative overflow-hidden px-4 py-20 lg:px-8 lg:py-32">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg text-muted-foreground">
          CompileX is a modern competitive programming platform featuring secure Docker-based
          code execution, contests, leaderboards, and real-time submission tracking.
        </p>
